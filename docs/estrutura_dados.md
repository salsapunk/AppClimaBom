...
- Utilizamos listas (para guardar as informações) em variáveis como '''clima_semana''' e '''dia''' em '''[resposta.py](http://resposta.py/)''' e dicionários (para organizar a resposta da API) como '''diario''' e '''horario'''
